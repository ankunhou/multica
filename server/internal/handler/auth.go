...
func (h *Handler) SendCode(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.EmailService.SendVerificationCode(email, code, locale); err != nil {
	...
	writeJSON(w, http.StatusOK, map[string]string{"message": i18n.VerificationCodeSentMessage(locale)})
}
