...
**环境要求：** [Node.js](https://nodejs.org/) v22+, [pnpm](https://pnpm.io/) v10.28+, [Go](https://go.dev/) v1.26.1+, [Docker](https://www.docker.com/)

```bash
just dev
```

完整的开发流程、测试和问题排查请参阅 [CONTRIBUTING.md](CONTRIBUTING.md)。
