...
export function ClaudeCodeLogo({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 248 248" aria-hidden="true" className={className} fill="currentColor">
...
export function headerButtonClassName(tone: "ghost" | "solid", variant: "dark" | "light" = "dark") {
  return cn(
