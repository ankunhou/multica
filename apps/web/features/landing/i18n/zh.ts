  ...
  return {
    ...
    features: {
      teammates: {
        ...
        cards: [
          ...
          {
            title: "自主参与",
            description: "智能体主动创建议题、发表评论、更新状态——而不是只在被提示时才行动。",
          },
          {
            title: "统一的活动时间线",
            description:
      ...
      autonomous: {
        ...
        cards: [
          ...
          {
            title: "主动报告阻塞",
            description: "当智能体遇到困难时，会立即发出警报。不用等几个小时后才发现什么都没发生。",
          },
          {
            title: "实时进度推送",
            description:
      ...
      skills: {
        ...
        cards: [
          ...
          {
            title: "全团队共享",
            description: "一个人的技能就是每个智能体的技能。编写一次，全团队受益。",
          },
          {
            title: "复合增长",
            description:
      ...
      runtimes: {
        ...
        cards: [
          {
            title: "统一运行时面板",
            description: "本地守护进程和云端运行时在同一视图中。无需在不同管理界面之间切换。",
          },
          {
            title: "实时监控",
            description: "在线/离线状态、使用量图表和活动热力图。随时了解你的算力在做什么。",
          },
          {
            title: "首次启动自动注册",
            description:
    ...
    openSource: {
      ...
      highlights: [
        ...
        {
          title: "无供应商锁定",
          description: "自带 LLM 提供商、更换智能体后端、扩展 API。你拥有整个技术栈的控制权。",
        },
        {
          title: "默认透明",
          description:
    ...
    footer: {
      tagline: "人类 + 智能体团队的项目管理。开源、可自托管、为未来的工作方式而建。",
      cta: "开始使用",
      groups: {
        product: {
          label: "产品",
    ...
    changelog: {
      ...
      entries: [
        ...
        },
        {
          ...
          title: "安全加固与通知",
          changes: [],
          features: ["子议题变更时通知父议题的订阅者", "CLI `--project` 筛选议题列表"],
