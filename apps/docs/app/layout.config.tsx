...
function MulticaMark() {
  return (
    <span className="inline-block size-[1em]" aria-hidden="true">
      <span className="block size-full bg-current" style={{ clipPath: MULTICA_CLIP }} />
    </span>
  );
}
...
function GitHubMark() {
  return (
    <svg viewBox="0 0 16 16" aria-hidden="true" className="size-[1em]" fill="currentColor">
...
export const baseOptions: BaseLayoutProps = {
  nav: {
    title: <span className="font-semibold text-base">Multica Docs</span>,
  },
  links: [
    {
      icon: <GitHubMark />,
