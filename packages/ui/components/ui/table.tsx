...
function Table({ className, ...props }: React.ComponentProps<"table">) {
  return (
    <div
      ...
      className="relative w-full overflow-x-auto rounded-2xl bg-card shadow-sm ring-1 ring-border/45"
    >
      <table
        data-slot="table"
...
function TableHeader({ className, ...props }: React.ComponentProps<"thead">) {
  return (
    <thead
      ...
      className={cn("bg-muted/15 [&_tr]:border-b [&_tr]:border-border/45", className)}
      {...props}
    />
  )
}
...
function TableFooter({ className, ...props }: React.ComponentProps<"tfoot">) {
  return (
    <tfoot
      ...
      className={cn(
        "border-t border-border/45 bg-muted/25 font-medium [&>tr]:last:border-b-0",
        className
      )}
      {...props}
    />
