      ...
      {sandboxedDocument ? (
        <>
          <iframe
            ...
            title={t(($) => $.mermaid.diagram_title)}
          />
          <div className="mermaid-diagram-toolbar">
            <button
              type="button"
              onClick={() => setLightboxOpen(true)}
              title={t(($) => $.mermaid.open_fullscreen)}
              aria-label={t(($) => $.mermaid.open_fullscreen_aria)}
            >
          ...
          {lightboxOpen && expandedDocument && (
            <MermaidLightbox
              ...
              label={t(($) => $.mermaid.fullscreen_aria)}
              title={t(($) => $.mermaid.fullscreen_title)}
            />
          )}
        </>
      ) : (
